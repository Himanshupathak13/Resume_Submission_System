  ...
  return (
    <div>
      ...
      <section style={{ backgroundColor: "#c5aa6a" }} className="text-center m-2 mt-2 p-2 d-flex aligns-items-center justify-content-md-center ">
        ...
        <h4 className="p-2 mt-5 text-center pt-3" style={{ color: "#741b47" }}>WELCOME TO RESUME SUBMISSION SYSTEM</h4>
      ...
      <Carousel className='m-2 p-2 ml-2 border-5 border border-dark w-100%' >
        <Carousel.Item>
          ...
          />
          <Carousel.Caption>
            <h3 className=''>Resume Submission System</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          <Carousel.Caption>
            <h3>Resume Submission System</h3>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
